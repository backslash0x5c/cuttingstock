...
def select_cutting_plan(all_combinations, required_cuts):
    ...
    while any(qty > 0 for qty in remaining.values()):
        ...
        print(f"{plan_num}: {best_combo['rod_length']}mm = {combo_str} + {best_combo['waste']}")
...
if __name__ == "__main__":
    ...
    required_cuts = {
        '4495': random.randint(0, 10000),
        '3585': random.randint(0, 10000),
        '2675': random.randint(0, 10000),
        '2600': random.randint(0, 10000),
        '2220': random.randint(0, 10000),
        '1765': random.randint(0, 10000), 
        '1310': random.randint(0, 10000),
        '1080': random.randint(0, 10000),
        '855': random.randint(0, 10000),
        '400': random.randint(0, 10000)
        }
    ...
    # あるケースでの切り出しプランのロス率
    loss_rate = select_cutting_plan(all_combinations, required_cuts)
